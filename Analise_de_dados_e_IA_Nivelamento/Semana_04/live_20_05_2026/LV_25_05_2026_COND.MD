...
<table style="text-align: center; width: 100%;"> 
     <tr>
         <td style="text-align: left;">
             <img src="imgs/ex_for.png" alt="Exemplo de utilização do Len" width="45%"/>
         </td>
     </tr>
 </table>
...
Para tal utilização utilizamos o seguinte comando :  
```python
for i in range(len(professores)):
    print(professores[i])
```

Em termos de sintaxe, os comandos divergem um do outro, porém da maneira como foi escrito acima, os resultados serão idênticos no que tange a saída em terminal de um comando `FOR var in list` por exemplo
---
...
__Data de Criação:__ 25-05-2026  
__Data de Modificação:__ 25-05-2026  
__Versão:__ "1.0"